import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Dianetické centrum Brno, z.s.", description: "Návrh moderního webu — Dianetické centrum Brno, z.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Dianetické centrum Brno, z.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
