import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Victoria Style", description: "Návrh moderního webu — Victoria Style" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#8a1c3b", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Victoria Style. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
