import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Stavební a zednické práce", description: "Návrh moderního webu — Stavební a zednické práce" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#8e2f1e", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Stavební a zednické práce. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
