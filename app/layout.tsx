import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Golovchak-Stav", description: "Návrh moderního webu — Golovchak-Stav" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Golovchak-Stav. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
