import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Na břehu Rhôny", description: "Návrh moderního webu — Na břehu Rhôny" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Na břehu Rhôny. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
