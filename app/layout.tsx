import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "DratON Elektro", description: "Návrh moderního webu — DratON Elektro" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#F6B21B", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy DratON Elektro. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
