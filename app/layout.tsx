import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pekárna Crocus", description: "Návrh moderního webu — Pekárna Crocus" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pekárna Crocus. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
