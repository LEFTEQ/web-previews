import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Autoservis Neugebauer", description: "Návrh moderního webu — Autoservis Neugebauer" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Autoservis Neugebauer. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
