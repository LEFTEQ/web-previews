import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Bike Assault", description: "Návrh moderního webu — Bike Assault" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#e6a52c", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Bike Assault. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
