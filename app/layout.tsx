import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pozdník David", description: "Návrh moderního webu — Pozdník David" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pozdník David. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
