  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy SAS nábytek (stolařství) | Ing. Pavel Sedláček. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
