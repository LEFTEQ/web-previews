import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Rodinný pivovar Bukovar", description: "Návrh moderního webu — Rodinný pivovar Bukovar" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#b5451c", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Rodinný pivovar Bukovar. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
