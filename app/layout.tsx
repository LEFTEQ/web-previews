import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Vladimír Háza", description: "Návrh moderního webu — Vladimír Háza" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Vladimír Háza. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
