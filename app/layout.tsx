import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Grand Palace Brno", description: "Návrh moderního webu — Grand Palace Brno" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Grand Palace Brno. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
