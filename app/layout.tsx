import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Štěkej.cz", description: "Návrh moderního webu — Štěkej.cz" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Štěkej.cz. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
