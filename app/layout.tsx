import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "U Toulavé pípy", description: "Návrh moderního webu — U Toulavé pípy" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#7e5a1e", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy U Toulavé pípy. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
