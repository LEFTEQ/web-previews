import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "MANE BETON", description: "Návrh moderního webu — MANE BETON" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#c68a3a", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy MANE BETON. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
