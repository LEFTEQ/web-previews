import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Metrostav A.s.", description: "Návrh moderního webu — Metrostav A.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Metrostav A.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
