import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Version Coffee", description: "Návrh moderního webu — Version Coffee" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Version Coffee. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
