import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Autoškola Sládek", description: "Návrh moderního webu — Autoškola Sládek" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Autoškola Sládek. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
