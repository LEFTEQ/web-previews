import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Železářství Modřany", description: "Návrh moderního webu — Železářství Modřany" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Železářství Modřany. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
