import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Vytisknuti.cz", description: "Návrh moderního webu — Vytisknuti.cz" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#00a5d8", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Vytisknuti.cz. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
