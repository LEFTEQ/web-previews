import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Martin Möller", description: "Návrh moderního webu — Martin Möller" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#C64A2E", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Martin Möller. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
