import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "RPD Auto CZ, a.s.", description: "Návrh moderního webu — RPD Auto CZ, a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy RPD Auto CZ, a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
