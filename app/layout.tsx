import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Matějovo pekařství", description: "Návrh moderního webu — Matějovo pekařství" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Matějovo pekařství. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
