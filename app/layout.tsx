import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Nakladatelství Lukáš a syn", description: "Návrh moderního webu — Nakladatelství Lukáš a syn" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#6f2233", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Nakladatelství Lukáš a syn. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
