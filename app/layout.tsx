import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Beauty Studio Viktoria", description: "Návrh moderního webu — Beauty Studio Viktoria" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#B76E79", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Beauty Studio Viktoria. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
