import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Urban Bloom", description: "Návrh moderního webu — Urban Bloom" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#3B5D3A", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Urban Bloom. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
