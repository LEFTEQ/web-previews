import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Jančík - Instal, s.r.o.", description: "Návrh moderního webu — Jančík - Instal, s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Jančík - Instal, s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
