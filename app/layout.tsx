import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Vopravil &amp; Buško V.o.s.", description: "Návrh moderního webu — Vopravil &amp; Buško V.o.s." };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#ff9e1b", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Vopravil &amp; Buško V.o.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
