import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "BP CARS", description: "Návrh moderního webu — BP CARS" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy BP CARS. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
