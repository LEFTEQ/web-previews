import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pelzer Interiéry", description: "Návrh moderního webu — Pelzer Interiéry" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pelzer Interiéry. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
