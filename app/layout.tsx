import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "1. HFK Olomouc", description: "Návrh moderního webu — 1. HFK Olomouc" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#0a7d3c", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy 1. HFK Olomouc. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
