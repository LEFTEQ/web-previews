import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "PROF SERVIS s.r.o.", description: "Návrh moderního webu — PROF SERVIS s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy PROF SERVIS s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
