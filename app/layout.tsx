import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Lamka Ladislav", description: "Návrh moderního webu — Lamka Ladislav" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Lamka Ladislav. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
