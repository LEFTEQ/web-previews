import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "DELUS KUCHYNĚ A INTERIÉRY", description: "Návrh moderního webu — DELUS KUCHYNĚ A INTERIÉRY" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#2457ff", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy DELUS KUCHYNĚ A INTERIÉRY. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
