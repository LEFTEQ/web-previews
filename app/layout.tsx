import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Zemní práce Kadlec", description: "Návrh moderního webu — Zemní práce Kadlec" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Zemní práce Kadlec. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
