import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Jazyková škola Extern", description: "Návrh moderního webu — Jazyková škola Extern" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Jazyková škola Extern. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
