import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Miroslav Veselý", description: "Návrh moderního webu — Miroslav Veselý" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Miroslav Veselý. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
