import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Penzion u Bláhů", description: "Návrh moderního webu — Penzion u Bláhů" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#7B3F2E", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Penzion u Bláhů. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
