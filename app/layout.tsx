import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "FC Viktoria Plzeň", description: "Návrh moderního webu — FC Viktoria Plzeň" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#ff2b45", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy FC Viktoria Plzeň. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
