import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pavel Kühnel", description: "Návrh moderního webu — Pavel Kühnel" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pavel Kühnel. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
