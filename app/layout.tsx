import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Presto Meat Market", description: "Návrh moderního webu — Presto Meat Market" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#6b1220", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Presto Meat Market. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
