import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "AUTOKEMP Liberec", description: "Návrh moderního webu — AUTOKEMP Liberec" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy AUTOKEMP Liberec. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
