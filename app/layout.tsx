import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Advokátní kancelář Všetečka &amp; partneři a spol.", description: "Návrh moderního webu — Advokátní kancelář Všetečka &amp; partneři a spol." };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#d3b874", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Advokátní kancelář Všetečka &amp; partneři a spol.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
