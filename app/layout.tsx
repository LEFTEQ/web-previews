import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pletemesi.cz", description: "Návrh moderního webu — Pletemesi.cz" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pletemesi.cz. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
