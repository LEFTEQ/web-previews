import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Cukrárna Kamel", description: "Návrh moderního webu — Cukrárna Kamel" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Cukrárna Kamel. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
