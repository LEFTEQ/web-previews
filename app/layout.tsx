import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pivovarský dům Poupě", description: "Návrh moderního webu — Pivovarský dům Poupě" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pivovarský dům Poupě. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
