import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Kadeřnictví No.1", description: "Návrh moderního webu — Kadeřnictví No.1" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Kadeřnictví No.1. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
