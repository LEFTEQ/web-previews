import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "O. K. reklama v.o.s.", description: "Návrh moderního webu — O. K. reklama v.o.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy O. K. reklama v.o.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
