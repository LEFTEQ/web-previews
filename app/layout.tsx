import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Hostinec U Tesaře", description: "Návrh moderního webu — Hostinec U Tesaře" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Hostinec U Tesaře. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
