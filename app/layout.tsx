import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Onderka Eduard", description: "Návrh moderního webu — Onderka Eduard" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#f0a173", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Onderka Eduard. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
