import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Meyra ČR s.r.o.", description: "Návrh moderního webu — Meyra ČR s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Meyra ČR s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
