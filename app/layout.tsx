import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Gama G+V", description: "Návrh moderního webu — Gama G+V" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Gama G+V. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
