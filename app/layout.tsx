import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Stavební Bytové Družstvo Poruba", description: "Návrh moderního webu — Stavební Bytové Družstvo Poruba" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#ffc531", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Stavební Bytové Družstvo Poruba. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
