import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Studio Zuzana", description: "Návrh moderního webu — Studio Zuzana" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Studio Zuzana. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
