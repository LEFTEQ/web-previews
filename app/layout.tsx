import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pavel Choleva", description: "Návrh moderního webu — Pavel Choleva" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pavel Choleva. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
