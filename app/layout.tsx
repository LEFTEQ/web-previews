import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Top Time", description: "Návrh moderního webu — Top Time" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#2b3a67", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Top Time. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
