import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Healthy Twenty Brno", description: "Návrh moderního webu — Healthy Twenty Brno" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Healthy Twenty Brno. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
