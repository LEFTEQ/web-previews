import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Restaurace U Dvořáčků", description: "Návrh moderního webu — Restaurace U Dvořáčků" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Restaurace U Dvořáčků. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
