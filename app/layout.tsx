import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Zemědělské Stavby A.s. Ústí Nad Labem", description: "Návrh moderního webu — Zemědělské Stavby A.s. Ústí Nad Labem" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#ffd83d", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Zemědělské Stavby A.s. Ústí Nad Labem. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
