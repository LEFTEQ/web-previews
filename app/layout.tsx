import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Lemak reality", description: "Návrh moderního webu — Lemak reality" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Lemak reality. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
