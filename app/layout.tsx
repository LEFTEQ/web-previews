import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Nátěry KBN", description: "Návrh moderního webu — Nátěry KBN" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#d5ec7d", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Nátěry KBN. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
