import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Rudolf Riezner", description: "Návrh moderního webu — Rudolf Riezner" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Rudolf Riezner. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
