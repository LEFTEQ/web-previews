import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Autocentrum Milocar", description: "Návrh moderního webu — Autocentrum Milocar" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Autocentrum Milocar. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
