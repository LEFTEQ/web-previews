import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Salon M", description: "Návrh moderního webu — Salon M" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#c76b7d", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Salon M. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
