import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Harmony Haven SPA", description: "Návrh moderního webu — Harmony Haven SPA" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#3a5a4c", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Harmony Haven SPA. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
