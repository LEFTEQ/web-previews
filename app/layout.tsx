import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "JB SPORT", description: "Návrh moderního webu — JB SPORT" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy JB SPORT. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
