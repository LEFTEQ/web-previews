import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "HOTEL INTERNATIONAL BRNO", description: "Návrh moderního webu — HOTEL INTERNATIONAL BRNO" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy HOTEL INTERNATIONAL BRNO. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
