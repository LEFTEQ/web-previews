import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pivovar Svijany", description: "Návrh moderního webu — Pivovar Svijany" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#e8a83a", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pivovar Svijany. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
