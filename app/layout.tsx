import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "MR. POKE", description: "Návrh moderního webu — MR. POKE" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#E9A21B", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy MR. POKE. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
