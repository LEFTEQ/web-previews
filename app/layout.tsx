import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Tepkom spol. S R.o.", description: "Návrh moderního webu — Tepkom spol. S R.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Tepkom spol. S R.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
