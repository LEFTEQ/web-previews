import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Capl &amp; Souček Advokátní Kancelář", description: "Návrh moderního webu — Capl &amp; Souček Advokátní Kancelář" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#cfb476", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Capl &amp; Souček Advokátní Kancelář. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
