import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pokojný malíř", description: "Návrh moderního webu — Pokojný malíř" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#263038", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pokojný malíř. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
