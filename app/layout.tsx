import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pivovar Rezek", description: "Návrh moderního webu — Pivovar Rezek" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pivovar Rezek. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
