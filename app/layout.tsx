import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Stavební bytové družstvo SEVER", description: "Návrh moderního webu — Stavební bytové družstvo SEVER" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#e35d1c", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Stavební bytové družstvo SEVER. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
