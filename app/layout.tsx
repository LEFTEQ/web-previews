import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "ABP HOLDING a.s.", description: "Návrh moderního webu — ABP HOLDING a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy ABP HOLDING a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
