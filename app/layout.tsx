import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "David Novotný", description: "Návrh moderního webu — David Novotný" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy David Novotný. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
