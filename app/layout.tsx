import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Šperky4U", description: "Návrh moderního webu — Šperky4U" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Šperky4U. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
