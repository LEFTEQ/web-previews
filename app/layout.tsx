import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Zednické a stavební práce", description: "Návrh moderního webu — Zednické a stavební práce" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#c86a3e", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Zednické a stavební práce. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
