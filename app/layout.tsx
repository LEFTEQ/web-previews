import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Advokátní kancelář Šmarda", description: "Návrh moderního webu — Advokátní kancelář Šmarda" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#a52a37", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Advokátní kancelář Šmarda. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
