import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Autolakovna K + P", description: "Návrh moderního webu — Autolakovna K + P" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Autolakovna K + P. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
