import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Žižkovská obchodní společnost s.r.o", description: "Návrh moderního webu — Žižkovská obchodní společnost s.r.o" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Žižkovská obchodní společnost s.r.o. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
