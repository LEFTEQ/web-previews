import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Flexi Tours", description: "Návrh moderního webu — Flexi Tours" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Flexi Tours. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
