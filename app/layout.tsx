import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Miroslav Vytásek", description: "Návrh moderního webu — Miroslav Vytásek" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Miroslav Vytásek. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
