import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "David Soviar", description: "Návrh moderního webu — David Soviar" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy David Soviar. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
