import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "TJ Slavia VŠ Plzeň", description: "Návrh moderního webu — TJ Slavia VŠ Plzeň" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy TJ Slavia VŠ Plzeň. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
