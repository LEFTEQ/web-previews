import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Hudera a syn s.r.o.", description: "Návrh moderního webu — Hudera a syn s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Hudera a syn s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
