import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "SPRÁVA A ÚDRŽBA SILNIC PARDUBICKÉHO KRAJE", description: "Návrh moderního webu — SPRÁVA A ÚDRŽBA SILNIC PARDUBICKÉHO KRAJE" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#e8531d", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy SPRÁVA A ÚDRŽBA SILNIC PARDUBICKÉHO KRAJE. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
