import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Forum Nová Karolina", description: "Návrh moderního webu — Forum Nová Karolina" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#C4453B", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Forum Nová Karolina. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
