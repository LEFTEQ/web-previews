import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "MMCAR | autoservis – autopůjčovna", description: "Návrh moderního webu — MMCAR | autoservis – autopůjčovna" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy MMCAR | autoservis – autopůjčovna. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
