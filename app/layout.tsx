import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pavliňák Petr", description: "Návrh moderního webu — Pavliňák Petr" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#1a1a1a", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pavliňák Petr. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
