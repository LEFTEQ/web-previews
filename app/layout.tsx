import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Robert Korec", description: "Návrh moderního webu — Robert Korec" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Robert Korec. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
