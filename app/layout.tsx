import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Svatby podle Katy", description: "Návrh moderního webu — Svatby podle Katy" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Svatby podle Katy. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
