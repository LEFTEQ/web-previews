import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Řemeslný pivovar Lomnice nad Popelkou", description: "Návrh moderního webu — Řemeslný pivovar Lomnice nad Popelkou" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#C6472B", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Řemeslný pivovar Lomnice nad Popelkou. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
