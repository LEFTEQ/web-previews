import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "AZ SERVIS", description: "Návrh moderního webu — AZ SERVIS" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy AZ SERVIS. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
