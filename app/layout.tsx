import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Cargo Bike Daddy", description: "Návrh moderního webu — Cargo Bike Daddy" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#1f8a7a", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Cargo Bike Daddy. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
