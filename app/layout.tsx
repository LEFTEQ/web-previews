import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "MVDr. Marek Chyba", description: "Návrh moderního webu — MVDr. Marek Chyba" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#0f5f5c", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy MVDr. Marek Chyba. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
