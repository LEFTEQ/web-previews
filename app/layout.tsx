import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Hugo chodí bos", description: "Návrh moderního webu — Hugo chodí bos" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#3e7d4c", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Hugo chodí bos. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
