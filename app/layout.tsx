import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Kavárna a bistro Chodský", description: "Návrh moderního webu — Kavárna a bistro Chodský" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Kavárna a bistro Chodský. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
