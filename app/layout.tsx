import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Zvánovec A.s.", description: "Návrh moderního webu — Zvánovec A.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Zvánovec A.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
