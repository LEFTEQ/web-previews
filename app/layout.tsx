import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Studio Aleš", description: "Návrh moderního webu — Studio Aleš" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Studio Aleš. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
