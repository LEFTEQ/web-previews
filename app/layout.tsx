import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "KODAP HK s.r.o.", description: "Návrh moderního webu — KODAP HK s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy KODAP HK s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
