import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Veterinární Klinika Sokolníky", description: "Návrh moderního webu — Veterinární Klinika Sokolníky" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#e79a4f", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Veterinární Klinika Sokolníky. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
