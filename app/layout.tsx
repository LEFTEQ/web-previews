import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Saviory Bricks", description: "Návrh moderního webu — Saviory Bricks" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Saviory Bricks. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
