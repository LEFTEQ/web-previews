import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Atelier Club", description: "Návrh moderního webu — Atelier Club" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Atelier Club. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
