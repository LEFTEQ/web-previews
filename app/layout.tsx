import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Takecars", description: "Návrh moderního webu — Takecars" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Takecars. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
