import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "ČESKÁ OCHRANNÁ SLUŽBA, a.s.", description: "Návrh moderního webu — ČESKÁ OCHRANNÁ SLUŽBA, a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy ČESKÁ OCHRANNÁ SLUŽBA, a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
