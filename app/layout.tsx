import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "AM Fitness", description: "Návrh moderního webu — AM Fitness" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#f3a179", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy AM Fitness. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
