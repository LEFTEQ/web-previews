import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "V klášteře", description: "Návrh moderního webu — V klášteře" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#a8712e", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy V klášteře. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
