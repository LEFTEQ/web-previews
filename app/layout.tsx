import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "GEREX Liberec, s.r.o.", description: "Návrh moderního webu — GEREX Liberec, s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy GEREX Liberec, s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
