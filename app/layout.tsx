import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "CHRPA stavební společnost v.o.s.", description: "Návrh moderního webu — CHRPA stavební společnost v.o.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy CHRPA stavební společnost v.o.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
