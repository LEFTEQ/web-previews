import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Kurštejn stavební a obchodní firma s.r.o.", description: "Návrh moderního webu — Kurštejn stavební a obchodní firma s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Kurštejn stavební a obchodní firma s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
