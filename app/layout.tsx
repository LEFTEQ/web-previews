import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Studio AnYo", description: "Návrh moderního webu — Studio AnYo" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Studio AnYo. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
