import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "RAP, krejčovský ateliér", description: "Návrh moderního webu — RAP, krejčovský ateliér" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy RAP, krejčovský ateliér. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
