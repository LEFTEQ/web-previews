import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Design Parket S.r.o.", description: "Návrh moderního webu — Design Parket S.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Design Parket S.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
