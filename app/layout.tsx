import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "FRYDL Servis", description: "Návrh moderního webu — FRYDL Servis" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy FRYDL Servis. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
