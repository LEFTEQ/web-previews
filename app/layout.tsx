import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "VIP bazény s.r.o.", description: "Návrh moderního webu — VIP bazény s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy VIP bazény s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
