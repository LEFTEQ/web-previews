import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "JPF SYSTEM s.r.o.", description: "Návrh moderního webu — JPF SYSTEM s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy JPF SYSTEM s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
