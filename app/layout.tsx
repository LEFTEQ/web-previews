import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Brabec vzduchotechnika", description: "Návrh moderního webu — Brabec vzduchotechnika" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#0B6E7A", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Brabec vzduchotechnika. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
