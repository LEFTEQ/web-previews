import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pavel Kulesa", description: "Návrh moderního webu — Pavel Kulesa" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#8f3f1c", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pavel Kulesa. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
