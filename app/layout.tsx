import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Stanislav Cinert", description: "Návrh moderního webu — Stanislav Cinert" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Stanislav Cinert. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
