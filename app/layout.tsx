import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Salon Witová", description: "Návrh moderního webu — Salon Witová" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Salon Witová. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
