import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Václav Moser", description: "Návrh moderního webu — Václav Moser" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Václav Moser. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
