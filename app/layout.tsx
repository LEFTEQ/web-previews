import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "EUC Klinika", description: "Návrh moderního webu — EUC Klinika" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy EUC Klinika. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
