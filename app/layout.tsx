import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Auto Matulka", description: "Návrh moderního webu — Auto Matulka" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Auto Matulka. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
