import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Karel Buček", description: "Návrh moderního webu — Karel Buček" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Karel Buček. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
