import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "S T A K O společnost s ručením omezeným", description: "Návrh moderního webu — S T A K O společnost s ručením omezeným" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#a2472a", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy S T A K O společnost s ručením omezeným. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
