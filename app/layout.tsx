import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "ROYAL PROSTĚJOV", description: "Návrh moderního webu — ROYAL PROSTĚJOV" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy ROYAL PROSTĚJOV. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
