import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Rehabilitační Centrum Šumava", description: "Návrh moderního webu — Rehabilitační Centrum Šumava" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Rehabilitační Centrum Šumava. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
