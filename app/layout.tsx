import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Školička Zahrada", description: "Návrh moderního webu — Školička Zahrada" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Školička Zahrada. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
