import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "MMM Auto", description: "Návrh moderního webu — MMM Auto" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy MMM Auto. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
