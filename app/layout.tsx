import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "KABO CZ", description: "Návrh moderního webu — KABO CZ" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy KABO CZ. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
