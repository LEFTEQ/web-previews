import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "HAS Car", description: "Návrh moderního webu — HAS Car" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy HAS Car. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
