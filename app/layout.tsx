import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Lezecké centrum V16", description: "Návrh moderního webu — Lezecké centrum V16" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#F03D2E", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Lezecké centrum V16. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
