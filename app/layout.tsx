import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "AUTO 3000 s.r.o.", description: "Návrh moderního webu — AUTO 3000 s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy AUTO 3000 s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
