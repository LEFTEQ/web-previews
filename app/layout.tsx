import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "VOD VOKA", description: "Návrh moderního webu — VOD VOKA" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy VOD VOKA. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
