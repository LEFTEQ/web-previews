import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pavel Kasl", description: "Návrh moderního webu — Pavel Kasl" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pavel Kasl. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
