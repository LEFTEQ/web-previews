import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "LBC reality", description: "Návrh moderního webu — LBC reality" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy LBC reality. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
