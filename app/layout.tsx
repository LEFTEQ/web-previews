import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Signature Travel", description: "Návrh moderního webu — Signature Travel" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#0f3d3e", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Signature Travel. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
