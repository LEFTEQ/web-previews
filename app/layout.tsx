import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Autoservis Michal", description: "Návrh moderního webu — Autoservis Michal" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Autoservis Michal. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
