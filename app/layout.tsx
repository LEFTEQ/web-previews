import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Jiří Rubinek", description: "Návrh moderního webu — Jiří Rubinek" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Jiří Rubinek. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
