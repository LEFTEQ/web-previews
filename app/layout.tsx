import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Buona Ventura", description: "Návrh moderního webu — Buona Ventura" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Buona Ventura. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
