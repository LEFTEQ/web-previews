import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "MVDr. Martin Petrlík", description: "Návrh moderního webu — MVDr. Martin Petrlík" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#2C7A6B", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy MVDr. Martin Petrlík. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
