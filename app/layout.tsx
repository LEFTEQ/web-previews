import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "HUSTÝ KÁRY", description: "Návrh moderního webu — HUSTÝ KÁRY" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy HUSTÝ KÁRY. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
