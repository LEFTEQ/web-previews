import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Super Panda Circus", description: "Návrh moderního webu — Super Panda Circus" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#FF2D6F", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Super Panda Circus. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
