import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Tepelná čerpadla IVT", description: "Návrh moderního webu — Tepelná čerpadla IVT" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#ff7a2f", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Tepelná čerpadla IVT. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
