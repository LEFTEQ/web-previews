import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Kytice, V.o.s.", description: "Návrh moderního webu — Kytice, V.o.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Kytice, V.o.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
