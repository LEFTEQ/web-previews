import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Michal Gilányi", description: "Návrh moderního webu — Michal Gilányi" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#1B3A6B", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Michal Gilányi. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
