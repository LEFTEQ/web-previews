import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Waza Security spol. S R.o.", description: "Návrh moderního webu — Waza Security spol. S R.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Waza Security spol. S R.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
