import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "ASTERIA vzdělávací centrum", description: "Návrh moderního webu — ASTERIA vzdělávací centrum" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#ff7a59", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy ASTERIA vzdělávací centrum. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
