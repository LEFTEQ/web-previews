import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "TECHNOPARK CZ s.r.o.", description: "Návrh moderního webu — TECHNOPARK CZ s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy TECHNOPARK CZ s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
