import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "JT LEGAL s.r.o., advokátní kancelář", description: "Návrh moderního webu — JT LEGAL s.r.o., advokátní kancelář" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#8a6a3a", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy JT LEGAL s.r.o., advokátní kancelář. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
