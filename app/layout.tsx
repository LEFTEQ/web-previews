import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Servis chlazení", description: "Návrh moderního webu — Servis chlazení" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Servis chlazení. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
