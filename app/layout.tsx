import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "STENO CZ", description: "Návrh moderního webu — STENO CZ" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy STENO CZ. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
