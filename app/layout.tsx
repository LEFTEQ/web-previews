import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Kareka spol. s r.o.", description: "Návrh moderního webu — Kareka spol. s r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Kareka spol. s r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
