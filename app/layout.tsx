import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "UNI HOBBY", description: "Návrh moderního webu — UNI HOBBY" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy UNI HOBBY. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
