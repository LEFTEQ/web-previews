import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "MVDr. Igor Beneš", description: "Návrh moderního webu — MVDr. Igor Beneš" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy MVDr. Igor Beneš. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
