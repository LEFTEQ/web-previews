import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Enkis a.s.", description: "Návrh moderního webu — Enkis a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Enkis a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
