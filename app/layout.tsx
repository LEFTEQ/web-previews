import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "APB - PLZEŇ a.s.", description: "Návrh moderního webu — APB - PLZEŇ a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy APB - PLZEŇ a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
