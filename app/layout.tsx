import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Korálky Katlas", description: "Návrh moderního webu — Korálky Katlas" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#7a2438", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Korálky Katlas. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
