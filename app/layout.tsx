import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Kamenictví Hořovice", description: "Návrh moderního webu — Kamenictví Hořovice" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#7a8a5f", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Kamenictví Hořovice. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
