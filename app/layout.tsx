import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Martina Burianová", description: "Návrh moderního webu — Martina Burianová" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#8a2b2f", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Martina Burianová. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
