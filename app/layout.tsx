import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Daňové Poradenství Tomáš Paclík, A.s.", description: "Návrh moderního webu — Daňové Poradenství Tomáš Paclík, A.s." };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#1f6f5c", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Daňové Poradenství Tomáš Paclík, A.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
