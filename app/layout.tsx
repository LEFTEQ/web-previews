import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Autosklo Střípek", description: "Návrh moderního webu — Autosklo Střípek" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Autosklo Střípek. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
