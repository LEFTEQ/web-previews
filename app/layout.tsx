import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "MATRIX Media", description: "Návrh moderního webu — MATRIX Media" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#00E5C7", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy MATRIX Media. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
