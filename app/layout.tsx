import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "1.Plzeňská daňová a účetní spol. s r.o.", description: "Návrh moderního webu — 1.Plzeňská daňová a účetní spol. s r.o." };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#b23a2e", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy 1.Plzeňská daňová a účetní spol. s r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
