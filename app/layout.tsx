import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "FBC Liberec", description: "Návrh moderního webu — FBC Liberec" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#ffe15c", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy FBC Liberec. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
