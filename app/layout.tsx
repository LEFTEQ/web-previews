import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Advokátní kancelář IVA JÓNOVÁ", description: "Návrh moderního webu — Advokátní kancelář IVA JÓNOVÁ" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#b08135", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Advokátní kancelář IVA JÓNOVÁ. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
