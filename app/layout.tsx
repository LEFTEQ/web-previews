import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "DMA Praha, s.r.o.", description: "Návrh moderního webu — DMA Praha, s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy DMA Praha, s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
