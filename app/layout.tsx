import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Řeznictví a uzenářství Oldřich Čejka", description: "Návrh moderního webu — Řeznictví a uzenářství Oldřich Čejka" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#8E1B2C", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Řeznictví a uzenářství Oldřich Čejka. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
