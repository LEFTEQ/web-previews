import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Kls Elektro S R.o.", description: "Návrh moderního webu — Kls Elektro S R.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Kls Elektro S R.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
