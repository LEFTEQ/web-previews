import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "STUDNY Doležel a Janíček, s.r.o.", description: "Návrh moderního webu — STUDNY Doležel a Janíček, s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy STUDNY Doležel a Janíček, s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
