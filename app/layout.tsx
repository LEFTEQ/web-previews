import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Diamond Nails", description: "Návrh moderního webu — Diamond Nails" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#d9a05b", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Diamond Nails. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
