import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "RT TORAX Group", description: "Návrh moderního webu — RT TORAX Group" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy RT TORAX Group. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
