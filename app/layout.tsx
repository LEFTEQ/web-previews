import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "4D Fyzioterapie", description: "Návrh moderního webu — 4D Fyzioterapie" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#c7f24a", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy 4D Fyzioterapie. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
