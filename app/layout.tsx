import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "AVE Pražské komunální služby a.s.", description: "Návrh moderního webu — AVE Pražské komunální služby a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy AVE Pražské komunální služby a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
