import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Garretto Praha", description: "Návrh moderního webu — Garretto Praha" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Garretto Praha. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
