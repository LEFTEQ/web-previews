import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Ing. Tomáš Mikulenka", description: "Návrh moderního webu — Ing. Tomáš Mikulenka" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Ing. Tomáš Mikulenka. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
