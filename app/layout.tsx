import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "MIROS Pardubice a.s.", description: "Návrh moderního webu — MIROS Pardubice a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy MIROS Pardubice a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
