import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "IN TIME KURÝR, s.r.o.", description: "Návrh moderního webu — IN TIME KURÝR, s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy IN TIME KURÝR, s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
