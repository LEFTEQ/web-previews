import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Ekonom-system S.r.o.", description: "Návrh moderního webu — Ekonom-system S.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Ekonom-system S.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
