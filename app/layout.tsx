import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Milan Penčák", description: "Návrh moderního webu — Milan Penčák" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Milan Penčák. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
