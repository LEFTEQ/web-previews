import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Interlingua Servis - Konečný Josef Ing.", description: "Návrh moderního webu — Interlingua Servis - Konečný Josef Ing." };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#1f4fd8", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Interlingua Servis - Konečný Josef Ing.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
