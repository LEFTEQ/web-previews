import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "STRABAG Rail a.s.", description: "Návrh moderního webu — STRABAG Rail a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy STRABAG Rail a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
