import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pivovar Žumberk", description: "Návrh moderního webu — Pivovar Žumberk" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#c9962e", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pivovar Žumberk. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
