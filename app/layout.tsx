import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Art Cafe", description: "Návrh moderního webu — Art Cafe" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Art Cafe. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
