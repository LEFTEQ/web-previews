import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "FŠ Servis Plzeň", description: "Návrh moderního webu — FŠ Servis Plzeň" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy FŠ Servis Plzeň. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
