import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Cestářské práce s.r.o.", description: "Návrh moderního webu — Cestářské práce s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Cestářské práce s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
