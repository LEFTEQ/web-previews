import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Geus okna a.s.", description: "Návrh moderního webu — Geus okna a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Geus okna a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
