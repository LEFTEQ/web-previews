import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Josef Přibyl", description: "Návrh moderního webu — Josef Přibyl" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Josef Přibyl. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
