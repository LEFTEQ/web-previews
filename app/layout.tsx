import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "J&amp;V OKNA", description: "Návrh moderního webu — J&amp;V OKNA" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy J&amp;V OKNA. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
