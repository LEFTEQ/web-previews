import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Radek Badin", description: "Návrh moderního webu — Radek Badin" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Radek Badin. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
