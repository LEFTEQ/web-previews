import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "I.T.C. - Jan Žižka", description: "Návrh moderního webu — I.T.C. - Jan Žižka" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy I.T.C. - Jan Žižka. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
