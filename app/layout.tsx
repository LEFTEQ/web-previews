import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Baštova zmrzlinárna", description: "Návrh moderního webu — Baštova zmrzlinárna" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#C22E58", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Baštova zmrzlinárna. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
