import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Technické služby Hostivice", description: "Návrh moderního webu — Technické služby Hostivice" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#0E7C9D", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Technické služby Hostivice. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
