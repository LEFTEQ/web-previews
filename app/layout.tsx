import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Zuzana Pražáková", description: "Návrh moderního webu — Zuzana Pražáková" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Zuzana Pražáková. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
