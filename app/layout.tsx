import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Optic Shop", description: "Návrh moderního webu — Optic Shop" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Optic Shop. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
