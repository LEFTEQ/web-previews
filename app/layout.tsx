import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "České brány, s.r.o.", description: "Návrh moderního webu — České brány, s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy České brány, s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
