import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Galant S.r.o.", description: "Návrh moderního webu — Galant S.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Galant S.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
