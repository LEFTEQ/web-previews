import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "STAVMAT Stavebniny", description: "Návrh moderního webu — STAVMAT Stavebniny" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy STAVMAT Stavebniny. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
