import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Bílí Tygři Liberec", description: "Návrh moderního webu — Bílí Tygři Liberec" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#0a2f7a", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Bílí Tygři Liberec. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
