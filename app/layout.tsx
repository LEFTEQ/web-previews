import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Krab Cycles", description: "Návrh moderního webu — Krab Cycles" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Krab Cycles. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
