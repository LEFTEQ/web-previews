import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "AutoFolie Wrap", description: "Návrh moderního webu — AutoFolie Wrap" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#C6FF3A", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy AutoFolie Wrap. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
