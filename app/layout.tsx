import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Jaroslav Morgenstern", description: "Návrh moderního webu — Jaroslav Morgenstern" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Jaroslav Morgenstern. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
