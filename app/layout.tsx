import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Zemní Práce Praha", description: "Návrh moderního webu — Zemní Práce Praha" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Zemní Práce Praha. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
