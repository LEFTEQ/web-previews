import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Hradecké oční sanatorium", description: "Návrh moderního webu — Hradecké oční sanatorium" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#1B7A6E", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Hradecké oční sanatorium. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
