import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Mgr. Antonín Poler", description: "Návrh moderního webu — Mgr. Antonín Poler" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#e08a52", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Mgr. Antonín Poler. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
