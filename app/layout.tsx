import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "MVF Servis", description: "Návrh moderního webu — MVF Servis" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy MVF Servis. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
