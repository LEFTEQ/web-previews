import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Health&amp;Beauty CLINIC", description: "Návrh moderního webu — Health&amp;Beauty CLINIC" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#8e3a55", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Health&amp;Beauty CLINIC. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
