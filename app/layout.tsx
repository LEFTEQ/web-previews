import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Abt Sezam S.r.o.", description: "Návrh moderního webu — Abt Sezam S.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Abt Sezam S.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
