import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Glanc Kuchyně", description: "Návrh moderního webu — Glanc Kuchyně" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Glanc Kuchyně. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
