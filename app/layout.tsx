import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "ZACÍLENÁ REKLAMA", description: "Návrh moderního webu — ZACÍLENÁ REKLAMA" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy ZACÍLENÁ REKLAMA. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
