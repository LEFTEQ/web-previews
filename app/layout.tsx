import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Dentální Centrum Z", description: "Návrh moderního webu — Dentální Centrum Z" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#2AA7A0", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Dentální Centrum Z. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
