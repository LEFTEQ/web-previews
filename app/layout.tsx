import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "MVDr. Ján Mach", description: "Návrh moderního webu — MVDr. Ján Mach" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#ef5a3c", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy MVDr. Ján Mach. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
