import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Terasy Café", description: "Návrh moderního webu — Terasy Café" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#e9a24a", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Terasy Café. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
