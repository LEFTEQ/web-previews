import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Profer Plus S.r.o.", description: "Návrh moderního webu — Profer Plus S.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Profer Plus S.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
