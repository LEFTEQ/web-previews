import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Nářadí Veselý Brno", description: "Návrh moderního webu — Nářadí Veselý Brno" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Nářadí Veselý Brno. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
