import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "KLIMATIZACE a TEPELNÁ ČERPADLA", description: "Návrh moderního webu — KLIMATIZACE a TEPELNÁ ČERPADLA" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#e8623b", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy KLIMATIZACE a TEPELNÁ ČERPADLA. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
