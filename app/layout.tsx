import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Čech &amp; syn stavební společnost, a.s.", description: "Návrh moderního webu — Čech &amp; syn stavební společnost, a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Čech &amp; syn stavební společnost, a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
