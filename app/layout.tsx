import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Lékárna Medipont Plus", description: "Návrh moderního webu — Lékárna Medipont Plus" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#1f7a6b", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Lékárna Medipont Plus. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
