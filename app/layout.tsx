import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Holflor Studio 1", description: "Návrh moderního webu — Holflor Studio 1" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#c8536b", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Holflor Studio 1. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
