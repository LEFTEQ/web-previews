import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Kafíčko 33", description: "Návrh moderního webu — Kafíčko 33" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#7A9A5B", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Kafíčko 33. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
