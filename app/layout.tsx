import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Stěhujeme - Hned", description: "Návrh moderního webu — Stěhujeme - Hned" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Stěhujeme - Hned. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
