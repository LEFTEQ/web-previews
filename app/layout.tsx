import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "SL CARS", description: "Návrh moderního webu — SL CARS" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy SL CARS. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
