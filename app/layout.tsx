import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Haaro Naturo", description: "Návrh moderního webu — Haaro Naturo" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Haaro Naturo. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
