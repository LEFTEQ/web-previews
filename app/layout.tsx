import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Food Truck Svoboda", description: "Návrh moderního webu — Food Truck Svoboda" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#d94f18", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Food Truck Svoboda. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
