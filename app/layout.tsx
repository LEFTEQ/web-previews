import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pyramida s.r.o.", description: "Návrh moderního webu — Pyramida s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pyramida s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
