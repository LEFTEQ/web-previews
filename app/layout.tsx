import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "MUDr. Daniel Dvořák", description: "Návrh moderního webu — MUDr. Daniel Dvořák" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy MUDr. Daniel Dvořák. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
