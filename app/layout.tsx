import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Potřebujete poradit? Zavolejte na číslo 800 505 090", description: "Návrh moderního webu — Potřebujete poradit? Zavolejte na číslo 800 505 090" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Potřebujete poradit? Zavolejte na číslo 800 505 090. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
