import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Papírnictví Petruška", description: "Návrh moderního webu — Papírnictví Petruška" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Papírnictví Petruška. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
