import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Střechy Sixta", description: "Návrh moderního webu — Střechy Sixta" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Střechy Sixta. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
