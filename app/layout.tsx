import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Hostinský pivovar Moritz", description: "Návrh moderního webu — Hostinský pivovar Moritz" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#e2662a", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Hostinský pivovar Moritz. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
