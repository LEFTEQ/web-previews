import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Koleje Pedagog", description: "Návrh moderního webu — Koleje Pedagog" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Koleje Pedagog. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
