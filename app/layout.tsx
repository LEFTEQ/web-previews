import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Anděl Tomáš", description: "Návrh moderního webu — Anděl Tomáš" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Anděl Tomáš. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
