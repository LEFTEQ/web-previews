import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Atelier Bar &amp; Bistro", description: "Návrh moderního webu — Atelier Bar &amp; Bistro" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#29348a", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Atelier Bar &amp; Bistro. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
