import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Emons Česká republika s.r.o.", description: "Návrh moderního webu — Emons Česká republika s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Emons Česká republika s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
