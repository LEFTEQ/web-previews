import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "ASKO - NÁBYTEK", description: "Návrh moderního webu — ASKO - NÁBYTEK" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy ASKO - NÁBYTEK. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
