import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "JF CARS", description: "Návrh moderního webu — JF CARS" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy JF CARS. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
