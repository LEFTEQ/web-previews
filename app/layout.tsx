import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Autoškola Korený", description: "Návrh moderního webu — Autoškola Korený" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Autoškola Korený. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
