import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Mgr.Jindra Bachmanová", description: "Návrh moderního webu — Mgr.Jindra Bachmanová" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Mgr.Jindra Bachmanová. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
