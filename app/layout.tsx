import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Bleskové překlady", description: "Návrh moderního webu — Bleskové překlady" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Bleskové překlady. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
