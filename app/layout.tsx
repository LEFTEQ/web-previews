import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "INGBAU CZ s.r.o.", description: "Návrh moderního webu — INGBAU CZ s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy INGBAU CZ s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
