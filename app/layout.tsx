import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Ing. Romana Dlouhá", description: "Návrh moderního webu — Ing. Romana Dlouhá" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Ing. Romana Dlouhá. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
