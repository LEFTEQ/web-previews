import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Zlatnická dílna Koneční", description: "Návrh moderního webu — Zlatnická dílna Koneční" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#c6a24c", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Zlatnická dílna Koneční. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
