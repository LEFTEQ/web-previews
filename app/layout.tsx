import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Bohemia Fr Systems S.r.o.", description: "Návrh moderního webu — Bohemia Fr Systems S.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Bohemia Fr Systems S.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
