import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Kávovary Burian", description: "Návrh moderního webu — Kávovary Burian" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Kávovary Burian. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
