import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Autoškola Suchánek", description: "Návrh moderního webu — Autoškola Suchánek" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Autoškola Suchánek. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
