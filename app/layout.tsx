import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Mgr. Jaroslav Toman, LL.M., advokát", description: "Návrh moderního webu — Mgr. Jaroslav Toman, LL.M., advokát" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Mgr. Jaroslav Toman, LL.M., advokát. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
