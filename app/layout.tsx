import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Veterina U Zoo", description: "Návrh moderního webu — Veterina U Zoo" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Veterina U Zoo. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
