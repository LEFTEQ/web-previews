import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "ASJ S.r.o.", description: "Návrh moderního webu — ASJ S.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy ASJ S.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
