import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Areál HoSPORT", description: "Návrh moderního webu — Areál HoSPORT" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#e8a95c", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Areál HoSPORT. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
