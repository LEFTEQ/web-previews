import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "the italians wine food", description: "Návrh moderního webu — the italians wine food" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy the italians wine food. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
