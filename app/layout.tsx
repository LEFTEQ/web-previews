import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "dm drogerie markt", description: "Návrh moderního webu — dm drogerie markt" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#002f6c", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy dm drogerie markt. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
