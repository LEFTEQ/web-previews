import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Půjčovna lešení Ostrava", description: "Návrh moderního webu — Půjčovna lešení Ostrava" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#f4c400", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Půjčovna lešení Ostrava. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
