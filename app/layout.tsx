import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Sever Plus S.r.o.", description: "Návrh moderního webu — Sever Plus S.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Sever Plus S.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
