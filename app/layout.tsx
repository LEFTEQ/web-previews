import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Leháro Street", description: "Návrh moderního webu — Leháro Street" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#ff5a4d", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Leháro Street. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
