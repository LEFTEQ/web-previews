import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Mgr. Martin Soppe", description: "Návrh moderního webu — Mgr. Martin Soppe" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Mgr. Martin Soppe. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
