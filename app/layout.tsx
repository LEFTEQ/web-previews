import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pan Alfréd", description: "Návrh moderního webu — Pan Alfréd" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pan Alfréd. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
