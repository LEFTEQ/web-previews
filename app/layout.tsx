import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Jamich s.r.o.", description: "Návrh moderního webu — Jamich s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Jamich s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
