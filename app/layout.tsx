import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Půjčovna MARENT", description: "Návrh moderního webu — Půjčovna MARENT" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Půjčovna MARENT. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
