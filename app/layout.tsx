import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "AC Interiér", description: "Návrh moderního webu — AC Interiér" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy AC Interiér. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
