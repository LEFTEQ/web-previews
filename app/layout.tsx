import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "HANÁK NÁBYTEK", description: "Návrh moderního webu — HANÁK NÁBYTEK" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#a8823f", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy HANÁK NÁBYTEK. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
