import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "AKROS, s.r.o.", description: "Návrh moderního webu — AKROS, s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy AKROS, s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
