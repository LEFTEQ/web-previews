import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Michal Přeslička", description: "Návrh moderního webu — Michal Přeslička" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Michal Přeslička. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
