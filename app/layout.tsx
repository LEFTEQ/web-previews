import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Družstvo HLS, výrobní družstvo Plzeň", description: "Návrh moderního webu — Družstvo HLS, výrobní družstvo Plzeň" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#1EE0C8", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Družstvo HLS, výrobní družstvo Plzeň. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
