import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "ViVa marketing", description: "Návrh moderního webu — ViVa marketing" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy ViVa marketing. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
