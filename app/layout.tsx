import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pivní ambasáda", description: "Návrh moderního webu — Pivní ambasáda" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pivní ambasáda. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
