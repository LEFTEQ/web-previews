import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Služba, výrobní družstvo", description: "Návrh moderního webu — Služba, výrobní družstvo" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Služba, výrobní družstvo. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
