import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Simona Beerová", description: "Návrh moderního webu — Simona Beerová" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Simona Beerová. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
