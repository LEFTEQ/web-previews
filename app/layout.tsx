import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Veterina Eden", description: "Návrh moderního webu — Veterina Eden" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#2f9c8f", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Veterina Eden. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
