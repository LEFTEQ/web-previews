import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Zámkařství Zemek s.r.o.", description: "Návrh moderního webu — Zámkařství Zemek s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Zámkařství Zemek s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
