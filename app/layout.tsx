import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Dentální hygiena", description: "Návrh moderního webu — Dentální hygiena" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#ff6a5b", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Dentální hygiena. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
