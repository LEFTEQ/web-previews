import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Muzikář Vladimír JUDr.", description: "Návrh moderního webu — Muzikář Vladimír JUDr." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Muzikář Vladimír JUDr.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
