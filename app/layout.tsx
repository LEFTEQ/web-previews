import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Autokomplex Baďura", description: "Návrh moderního webu — Autokomplex Baďura" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Autokomplex Baďura. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
