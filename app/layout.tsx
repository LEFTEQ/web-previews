import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Maximal Limit", description: "Návrh moderního webu — Maximal Limit" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Maximal Limit. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
