import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "ALLSTAR TRADING s.r.o.", description: "Návrh moderního webu — ALLSTAR TRADING s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy ALLSTAR TRADING s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
