import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Advokátní kancelář JUDr. Jiří Kos, MSc.", description: "Návrh moderního webu — Advokátní kancelář JUDr. Jiří Kos, MSc." };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#d6b877", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Advokátní kancelář JUDr. Jiří Kos, MSc.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
