import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Penzion Emma", description: "Návrh moderního webu — Penzion Emma" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Penzion Emma. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
