import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "BLM účetnictví s.r.o.", description: "Návrh moderního webu — BLM účetnictví s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy BLM účetnictví s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
