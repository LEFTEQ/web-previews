import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Moravostav Brno, A.s. Stavební Společnost", description: "Návrh moderního webu — Moravostav Brno, A.s. Stavební Společnost" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#F03A17", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Moravostav Brno, A.s. Stavební Společnost. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
