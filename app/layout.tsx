import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "DAY Spa Shop", description: "Návrh moderního webu — DAY Spa Shop" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#9c4826", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy DAY Spa Shop. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
