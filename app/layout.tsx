import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Okresní stavební bytové družstvo", description: "Návrh moderního webu — Okresní stavební bytové družstvo" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Okresní stavební bytové družstvo. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
