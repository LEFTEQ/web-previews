import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "e-železářství", description: "Návrh moderního webu — e-železářství" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy e-železářství. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
