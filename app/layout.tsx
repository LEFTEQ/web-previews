import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Logosign", description: "Návrh moderního webu — Logosign" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Logosign. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
