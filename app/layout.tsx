import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Knihkupectví a antikvariát Fryč", description: "Návrh moderního webu — Knihkupectví a antikvariát Fryč" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#7a2e1f", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Knihkupectví a antikvariát Fryč. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
