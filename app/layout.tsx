import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "AUTO-VYHYBKA", description: "Návrh moderního webu — AUTO-VYHYBKA" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy AUTO-VYHYBKA. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
