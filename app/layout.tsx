import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Autoškola Baumruk", description: "Návrh moderního webu — Autoškola Baumruk" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#d4232e", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Autoškola Baumruk. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
