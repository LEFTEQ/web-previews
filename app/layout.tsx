import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Patrik Vašků", description: "Návrh moderního webu — Patrik Vašků" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#dc9a4a", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Patrik Vašků. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
