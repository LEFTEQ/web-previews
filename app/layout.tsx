import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Stěhování Hanč", description: "Návrh moderního webu — Stěhování Hanč" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Stěhování Hanč. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
