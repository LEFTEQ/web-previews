import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "MUJPES.CZ", description: "Návrh moderního webu — MUJPES.CZ" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy MUJPES.CZ. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
