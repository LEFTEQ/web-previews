import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Bistro Fino", description: "Návrh moderního webu — Bistro Fino" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Bistro Fino. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
