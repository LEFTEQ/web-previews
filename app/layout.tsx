import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Tělocvičná jednota Sokol Plzeň 1", description: "Návrh moderního webu — Tělocvičná jednota Sokol Plzeň 1" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#8a1d14", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Tělocvičná jednota Sokol Plzeň 1. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
