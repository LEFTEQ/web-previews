import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Hal Servis Group A.s.", description: "Návrh moderního webu — Hal Servis Group A.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Hal Servis Group A.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
