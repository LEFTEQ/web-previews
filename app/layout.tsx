import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "H - Propag", description: "Návrh moderního webu — H - Propag" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#c0301f", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy H - Propag. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
