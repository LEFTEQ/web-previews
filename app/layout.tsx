import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Fiduciam consilio", description: "Návrh moderního webu — Fiduciam consilio" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Fiduciam consilio. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
