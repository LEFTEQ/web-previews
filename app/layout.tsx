import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Studio zdravého pohybu", description: "Návrh moderního webu — Studio zdravého pohybu" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#d98a5e", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Studio zdravého pohybu. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
