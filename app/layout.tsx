import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Defenders gym", description: "Návrh moderního webu — Defenders gym" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Defenders gym. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
