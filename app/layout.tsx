import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "PSYCHOLOGICKÉ CENTRUM LIBEREC", description: "Návrh moderního webu — PSYCHOLOGICKÉ CENTRUM LIBEREC" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy PSYCHOLOGICKÉ CENTRUM LIBEREC. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
