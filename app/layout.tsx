import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Řeznictví a Uzenářství Plot", description: "Návrh moderního webu — Řeznictví a Uzenářství Plot" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#5e1019", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Řeznictví a Uzenářství Plot. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
