import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Přejít k hlavnímu obsahu", description: "Návrh moderního webu — Přejít k hlavnímu obsahu" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Přejít k hlavnímu obsahu. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
