import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "High Security", description: "Návrh moderního webu — High Security" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy High Security. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
