import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Centrum léčebné rehabilitace Liberec", description: "Návrh moderního webu — Centrum léčebné rehabilitace Liberec" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#EA5C3D", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Centrum léčebné rehabilitace Liberec. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
