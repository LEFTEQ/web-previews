import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Hotel Royal Ricc", description: "Návrh moderního webu — Hotel Royal Ricc" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Hotel Royal Ricc. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
