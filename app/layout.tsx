import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "TJ Slavoj Plzeň", description: "Návrh moderního webu — TJ Slavoj Plzeň" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy TJ Slavoj Plzeň. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
