import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Petra Rabasová", description: "Návrh moderního webu — Petra Rabasová" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#127a82", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Petra Rabasová. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
