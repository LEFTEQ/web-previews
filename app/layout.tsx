import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Chlebíček store", description: "Návrh moderního webu — Chlebíček store" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Chlebíček store. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
