import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Kamenosochařství Sedlák", description: "Návrh moderního webu — Kamenosochařství Sedlák" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Kamenosochařství Sedlák. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
