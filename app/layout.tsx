import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Big Food Point", description: "Návrh moderního webu — Big Food Point" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Big Food Point. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
