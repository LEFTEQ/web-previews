import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Robert Misiorz", description: "Návrh moderního webu — Robert Misiorz" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Robert Misiorz. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
