import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Lešení Rar, S.r.o.", description: "Návrh moderního webu — Lešení Rar, S.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Lešení Rar, S.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
