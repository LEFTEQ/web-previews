import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Soliter", description: "Návrh moderního webu — Soliter" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Soliter. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
