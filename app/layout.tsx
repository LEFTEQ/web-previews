import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Print Adámek", description: "Návrh moderního webu — Print Adámek" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Print Adámek. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
