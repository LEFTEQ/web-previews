import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Hotel Victoria", description: "Návrh moderního webu — Hotel Victoria" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Hotel Victoria. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
