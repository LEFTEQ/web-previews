import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "MC Koloseum", description: "Návrh moderního webu — MC Koloseum" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy MC Koloseum. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
