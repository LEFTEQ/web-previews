import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Auto Moto Brno", description: "Návrh moderního webu — Auto Moto Brno" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Auto Moto Brno. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
