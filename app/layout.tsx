import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Finance Quality S.r.o.", description: "Návrh moderního webu — Finance Quality S.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Finance Quality S.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
