import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pneuservis Hanzal", description: "Návrh moderního webu — Pneuservis Hanzal" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pneuservis Hanzal. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
