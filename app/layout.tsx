import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Četrans A. S.", description: "Návrh moderního webu — Četrans A. S." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Četrans A. S.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
