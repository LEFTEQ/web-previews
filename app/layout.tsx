import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "MVDr. Saviola Richard", description: "Návrh moderního webu — MVDr. Saviola Richard" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy MVDr. Saviola Richard. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
