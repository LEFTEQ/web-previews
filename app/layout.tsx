import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Mototechna Drive", description: "Návrh moderního webu — Mototechna Drive" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Mototechna Drive. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
