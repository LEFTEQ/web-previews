import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Dům Duševního Zdraví", description: "Návrh moderního webu — Dům Duševního Zdraví" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#dd9a7c", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Dům Duševního Zdraví. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
