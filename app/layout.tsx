import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Milan Přikryl", description: "Návrh moderního webu — Milan Přikryl" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Milan Přikryl. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
