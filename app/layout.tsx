import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Geis CZ", description: "Návrh moderního webu — Geis CZ" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Geis CZ. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
