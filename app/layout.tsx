import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pet Care Clinic", description: "Návrh moderního webu — Pet Care Clinic" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#1f6b66", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Pet Care Clinic. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
