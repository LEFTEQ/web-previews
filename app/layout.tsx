import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Radovan Chromý", description: "Návrh moderního webu — Radovan Chromý" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Radovan Chromý. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
