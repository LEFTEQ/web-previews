import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "PHT a.s.", description: "Návrh moderního webu — PHT a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy PHT a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
