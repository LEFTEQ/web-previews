import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "V K S Praha s.r.o.", description: "Návrh moderního webu — V K S Praha s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy V K S Praha s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
