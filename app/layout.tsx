import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Hungaro Delikates", description: "Návrh moderního webu — Hungaro Delikates" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#c1301b", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Hungaro Delikates. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
