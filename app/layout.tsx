import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Maonel s.r.o.", description: "Návrh moderního webu — Maonel s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Maonel s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
