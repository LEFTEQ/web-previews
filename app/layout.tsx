import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Martin Veselý", description: "Návrh moderního webu — Martin Veselý" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#b07a2f", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Martin Veselý. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
