import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Josef Knajbl", description: "Návrh moderního webu — Josef Knajbl" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#0b4a68", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Josef Knajbl. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
