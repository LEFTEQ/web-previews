import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "H Centrum", description: "Návrh moderního webu — H Centrum" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy H Centrum. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
