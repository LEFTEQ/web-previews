import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Digitální studio", description: "Návrh moderního webu — Digitální studio" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Digitální studio. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
