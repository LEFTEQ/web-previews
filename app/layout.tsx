import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pekárny a cukrárny Náchod, a.s.", description: "Návrh moderního webu — Pekárny a cukrárny Náchod, a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pekárny a cukrárny Náchod, a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
