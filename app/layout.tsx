import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Línková Šárka JUDr.", description: "Návrh moderního webu — Línková Šárka JUDr." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Línková Šárka JUDr.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
