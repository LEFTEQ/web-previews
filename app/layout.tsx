import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Truhlářství AK Work", description: "Návrh moderního webu — Truhlářství AK Work" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#0d6efd", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Truhlářství AK Work. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
