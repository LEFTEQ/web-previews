import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Kominictví Němec", description: "Návrh moderního webu — Kominictví Němec" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Kominictví Němec. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
