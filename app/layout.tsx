import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Auto Licar s.r.o.", description: "Návrh moderního webu — Auto Licar s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Auto Licar s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
