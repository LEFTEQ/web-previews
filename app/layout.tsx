import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Plážový Klub Pískomil", description: "Návrh moderního webu — Plážový Klub Pískomil" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#b8461f", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Plážový Klub Pískomil. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
