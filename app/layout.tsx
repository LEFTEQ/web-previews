import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Květiny Za oponou", description: "Návrh moderního webu — Květiny Za oponou" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Květiny Za oponou. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
