import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Zednické Práce, Stavební práce", description: "Návrh moderního webu — Zednické Práce, Stavební práce" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#C94B24", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Zednické Práce, Stavební práce. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
