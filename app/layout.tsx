import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Rockfoil Artwork Co., Ltd. odštěpný závod", description: "Návrh moderního webu — Rockfoil Artwork Co., Ltd. odštěpný závod" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#c2833f", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Rockfoil Artwork Co., Ltd. odštěpný závod. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
