import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Kuchyně NEST", description: "Návrh moderního webu — Kuchyně NEST" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#a9863d", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Kuchyně NEST. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
