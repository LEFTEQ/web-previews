import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Kamnářství Jířa", description: "Návrh moderního webu — Kamnářství Jířa" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Kamnářství Jířa. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
