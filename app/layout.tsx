import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Detail House", description: "Návrh moderního webu — Detail House" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#0c4bb3", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Detail House. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
