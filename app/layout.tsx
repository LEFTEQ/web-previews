import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Burrito Loco", description: "Návrh moderního webu — Burrito Loco" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#e0231f", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Burrito Loco. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
