import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "SP KOLO", description: "Návrh moderního webu — SP KOLO" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#d8202b", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy SP KOLO. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
