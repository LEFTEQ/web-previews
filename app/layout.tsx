import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Bidli reality a.s.", description: "Návrh moderního webu — Bidli reality a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Bidli reality a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
