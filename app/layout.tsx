import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "AD LANDEK", description: "Návrh moderního webu — AD LANDEK" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy AD LANDEK. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
