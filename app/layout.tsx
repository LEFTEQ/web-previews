import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Spolek účetních Olomouc", description: "Návrh moderního webu — Spolek účetních Olomouc" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#1b4d3e", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Spolek účetních Olomouc. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
