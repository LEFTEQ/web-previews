import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Alois Stehno", description: "Návrh moderního webu — Alois Stehno" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Alois Stehno. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
