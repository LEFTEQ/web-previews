import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Chleba Brno", description: "Návrh moderního webu — Chleba Brno" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#6b3410", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Chleba Brno. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
