import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Vik Jiří - Tepelná Technika", description: "Návrh moderního webu — Vik Jiří - Tepelná Technika" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Vik Jiří - Tepelná Technika. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
