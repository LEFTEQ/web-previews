import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Jiří Kappl", description: "Návrh moderního webu — Jiří Kappl" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Jiří Kappl. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
