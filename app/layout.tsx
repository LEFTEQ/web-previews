import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pro Nails &amp; Beauty", description: "Návrh moderního webu — Pro Nails &amp; Beauty" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#C9184A", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pro Nails &amp; Beauty. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
