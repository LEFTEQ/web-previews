import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Hotel Gol", description: "Návrh moderního webu — Hotel Gol" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#e8b93c", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Hotel Gol. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
