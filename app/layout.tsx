import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Lékárna METRO Petřiny", description: "Návrh moderního webu — Lékárna METRO Petřiny" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#8fd9b6", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Lékárna METRO Petřiny. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
