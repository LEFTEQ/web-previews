import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Fyzioterapie Fit and Tasty s.r.o.", description: "Návrh moderního webu — Fyzioterapie Fit and Tasty s.r.o." };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#15a196", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Fyzioterapie Fit and Tasty s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
