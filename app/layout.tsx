import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "PRIME STUDIO", description: "Návrh moderního webu — PRIME STUDIO" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy PRIME STUDIO. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
