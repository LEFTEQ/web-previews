import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "advokátní kancelář Poláček", description: "Návrh moderního webu — advokátní kancelář Poláček" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#7A2E2E", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy advokátní kancelář Poláček. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
