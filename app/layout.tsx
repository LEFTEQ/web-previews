import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pharmacentrum NIKOS, s.r.o.", description: "Návrh moderního webu — Pharmacentrum NIKOS, s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pharmacentrum NIKOS, s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
