import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Centrum grafických papírů", description: "Návrh moderního webu — Centrum grafických papírů" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#c8402c", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Centrum grafických papírů. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
