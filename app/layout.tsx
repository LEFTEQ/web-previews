import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Tomáš Strašík, Kantor Sport", description: "Návrh moderního webu — Tomáš Strašík, Kantor Sport" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#f2c14e", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Tomáš Strašík, Kantor Sport. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
