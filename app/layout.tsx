import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Klub sportovního tance QUICK Olomouc", description: "Návrh moderního webu — Klub sportovního tance QUICK Olomouc" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#ff5a3c", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Klub sportovního tance QUICK Olomouc. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
