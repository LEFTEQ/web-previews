import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Stračena Pub", description: "Návrh moderního webu — Stračena Pub" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Stračena Pub. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
