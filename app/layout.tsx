import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Moto assistance s.r.o.", description: "Návrh moderního webu — Moto assistance s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Moto assistance s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
