import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "ČECHYMEN", description: "Návrh moderního webu — ČECHYMEN" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy ČECHYMEN. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
