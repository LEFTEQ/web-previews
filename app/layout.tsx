import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Hotel Na Kafkové", description: "Návrh moderního webu — Hotel Na Kafkové" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#d99a3a", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Hotel Na Kafkové. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
