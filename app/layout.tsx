import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "ABACK linguistic consulting", description: "Návrh moderního webu — ABACK linguistic consulting" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#C6402B", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy ABACK linguistic consulting. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
