import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Jiří Čoupek", description: "Návrh moderního webu — Jiří Čoupek" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Jiří Čoupek. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
