import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "AUTO DRYML a.s.", description: "Návrh moderního webu — AUTO DRYML a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy AUTO DRYML a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
