import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Sun For You S.r.o.", description: "Návrh moderního webu — Sun For You S.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Sun For You S.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
