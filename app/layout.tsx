import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Procházka Petr, JUDr., advokát", description: "Návrh moderního webu — Procházka Petr, JUDr., advokát" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#d9b95f", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Procházka Petr, JUDr., advokát. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
