import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Cafedu", description: "Návrh moderního webu — Cafedu" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Cafedu. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
