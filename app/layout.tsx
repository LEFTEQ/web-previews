import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Doktor Důlek s.r.o.", description: "Návrh moderního webu — Doktor Důlek s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Doktor Důlek s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
