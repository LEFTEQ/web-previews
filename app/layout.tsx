import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: ""Centrum Léčebné Rehabilitace Liberec, S.r.o."", description: "Návrh moderního webu — "Centrum Léčebné Rehabilitace Liberec, S.r.o."" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy "Centrum Léčebné Rehabilitace Liberec, S.r.o.". Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
