import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "CINOGROUP s.r.o.", description: "Návrh moderního webu — CINOGROUP s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy CINOGROUP s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
