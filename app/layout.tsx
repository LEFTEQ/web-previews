import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Dobrá čajovna", description: "Návrh moderního webu — Dobrá čajovna" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Dobrá čajovna. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
