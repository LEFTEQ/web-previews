import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "ATM CZ a.s.", description: "Návrh moderního webu — ATM CZ a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy ATM CZ a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
