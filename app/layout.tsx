import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Isofen Power s.r.o.", description: "Návrh moderního webu — Isofen Power s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Isofen Power s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
