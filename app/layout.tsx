import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Autoškola 97", description: "Návrh moderního webu — Autoškola 97" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Autoškola 97. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
