import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "DAP - LIBEREC a.s.", description: "Návrh moderního webu — DAP - LIBEREC a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy DAP - LIBEREC a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
