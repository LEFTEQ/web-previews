import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Květinářství GALERIE Brno", description: "Návrh moderního webu — Květinářství GALERIE Brno" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Květinářství GALERIE Brno. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
