import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Outlet Arena Moravia", description: "Návrh moderního webu — Outlet Arena Moravia" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Outlet Arena Moravia. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
