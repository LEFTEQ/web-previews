import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Olomouc CITY", description: "Návrh moderního webu — Olomouc CITY" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Olomouc CITY. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
