import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Pekařství a cukrářství Sázava", description: "Návrh moderního webu — Pekařství a cukrářství Sázava" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#B5322C", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Pekařství a cukrářství Sázava. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
