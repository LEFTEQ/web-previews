import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "AUTOSALON Běhounek, s. r. o.", description: "Návrh moderního webu — AUTOSALON Běhounek, s. r. o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy AUTOSALON Běhounek, s. r. o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
