import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Servis MARO s.r.o", description: "Návrh moderního webu — Servis MARO s.r.o" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Servis MARO s.r.o. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
