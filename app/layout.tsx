import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "NEJČI nábytek", description: "Návrh moderního webu — NEJČI nábytek" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy NEJČI nábytek. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
