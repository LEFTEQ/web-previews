import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "PROFORZA finance, a.s.", description: "Návrh moderního webu — PROFORZA finance, a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy PROFORZA finance, a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
