import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "REALITNÍ KANCELÁŘ PUBEC s.r.o.", description: "Návrh moderního webu — REALITNÍ KANCELÁŘ PUBEC s.r.o." };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#c6592e", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy REALITNÍ KANCELÁŘ PUBEC s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
