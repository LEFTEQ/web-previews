import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Stěhování Cibulka", description: "Návrh moderního webu — Stěhování Cibulka" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#ffc72a", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Stěhování Cibulka. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
