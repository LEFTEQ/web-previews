import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Esthetic Beauty", description: "Návrh moderního webu — Esthetic Beauty" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Esthetic Beauty. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
