import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "North stav a.s.", description: "Návrh moderního webu — North stav a.s." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy North stav a.s.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
