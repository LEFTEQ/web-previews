import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "AUTOSERVIS NEDVĚD s.r.o. - Škoda", description: "Návrh moderního webu — AUTOSERVIS NEDVĚD s.r.o. - Škoda" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#f2c400", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy AUTOSERVIS NEDVĚD s.r.o. - Škoda. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
