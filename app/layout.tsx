import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "AB Centrum", description: "Návrh moderního webu — AB Centrum" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy AB Centrum. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
