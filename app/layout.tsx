import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Jaromír Kolář", description: "Návrh moderního webu — Jaromír Kolář" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Jaromír Kolář. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
