import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Galerie Slovany", description: "Návrh moderního webu — Galerie Slovany" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Galerie Slovany. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
