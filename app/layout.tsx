import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Tomáš Růt", description: "Návrh moderního webu — Tomáš Růt" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#e29b76", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Tomáš Růt. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
