import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "PT Tours International", description: "Návrh moderního webu — PT Tours International" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#0a5cae", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy PT Tours International. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
