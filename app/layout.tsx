import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "PLOTOVÉ CENTRUM KOPEČEK s.r.o.", description: "Návrh moderního webu — PLOTOVÉ CENTRUM KOPEČEK s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy PLOTOVÉ CENTRUM KOPEČEK s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
