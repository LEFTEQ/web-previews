import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Bike-Boys", description: "Návrh moderního webu — Bike-Boys" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#86ff33", ["--lv-accent-text" as string]: "#111827" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Bike-Boys. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
