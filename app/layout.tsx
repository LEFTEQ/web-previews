import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Rosmarino Květinový Ateliér", description: "Návrh moderního webu — Rosmarino Květinový Ateliér" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Rosmarino Květinový Ateliér. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
