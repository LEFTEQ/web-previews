import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Mistr Pizza", description: "Návrh moderního webu — Mistr Pizza" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#C8371F", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Mistr Pizza. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
