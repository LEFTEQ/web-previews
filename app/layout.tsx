import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "MIZ Olomouc", description: "Návrh moderního webu — MIZ Olomouc" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy MIZ Olomouc. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
