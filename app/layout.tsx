import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Oční klinika", description: "Návrh moderního webu — Oční klinika" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#0F8A63", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Oční klinika. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
