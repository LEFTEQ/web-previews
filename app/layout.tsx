import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Natural Wine Shop", description: "Návrh moderního webu — Natural Wine Shop" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#E4842B", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Natural Wine Shop. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
