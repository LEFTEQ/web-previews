import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "HC Olomouc", description: "Návrh moderního webu — HC Olomouc" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy HC Olomouc. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
