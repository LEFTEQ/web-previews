import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Moravec Stanislav", description: "Návrh moderního webu — Moravec Stanislav" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Moravec Stanislav. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
