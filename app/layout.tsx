import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "U Lidušky", description: "Návrh moderního webu — U Lidušky" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy U Lidušky. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
