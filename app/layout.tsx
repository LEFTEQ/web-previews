import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "AEC NOVÁK s.r.o.", description: "Návrh moderního webu — AEC NOVÁK s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy AEC NOVÁK s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
