import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "MATEP s.r.o.", description: "Návrh moderního webu — MATEP s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy MATEP s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
