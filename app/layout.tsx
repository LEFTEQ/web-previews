import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Zahradnictví Krumlov", description: "Návrh moderního webu — Zahradnictví Krumlov" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#3f7d3a", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Zahradnictví Krumlov. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
