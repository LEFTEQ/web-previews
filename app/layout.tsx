import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "AA - účetní, s.r.o.", description: "Návrh moderního webu — AA - účetní, s.r.o." };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy AA - účetní, s.r.o.. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
