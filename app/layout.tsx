import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Mgr. JAKUB HRUBÝ, advokát", description: "Návrh moderního webu — Mgr. JAKUB HRUBÝ, advokát" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Mgr. JAKUB HRUBÝ, advokát. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
