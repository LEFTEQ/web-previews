import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Brněnská pohřební služba", description: "Návrh moderního webu — Brněnská pohřební služba" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#d8a45a", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia vyrobna.ai — ne oficiální web firmy Brněnská pohřební služba. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
