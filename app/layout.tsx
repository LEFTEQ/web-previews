import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Miroslav Pačan", description: "Návrh moderního webu — Miroslav Pačan" };
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="cs">
      <body>
        {children}
      <section className="lv-cta" aria-label="Nabídka nového webu" style={{ ["--lv-accent" as string]: "#1466a0", ["--lv-accent-text" as string]: "#ffffff" }}>
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Miroslav Pačan. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
