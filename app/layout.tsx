import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "Karel Duras", description: "Návrh moderního webu — Karel Duras" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy Karel Duras. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
