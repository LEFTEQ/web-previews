import "./globals.css";
import "./_lovinka.css";
export const metadata = { title: "The Miners Slavíkova", description: "Návrh moderního webu — The Miners Slavíkova" };
  ...
  return (
    <html lang="cs">
      ...
      <footer className="lv-foot">
        <p>Toto je nezávazný designový návrh studia lovinka — ne oficiální web firmy The Miners Slavíkova. Návrh nepoužívá skutečné logo firmy.</p>
      </footer>
      </body>
    </html>
  );
