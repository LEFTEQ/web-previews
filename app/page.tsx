        ...
        <div className="hero-inner">
          <div className="hero-copy">
            ...
            <p className="hero-lead">
              ...
              Patnáct let měříme trh do detailu — poctivě a osobně, jako by šlo o naši vlastní nemovitost.
            </p>
            ...
            {NABIDKA.map((it) => (
              <article className="plot" key={it.parcel}>
                ...
                <div className="plot-figure">
                  <AiImage src={it.img} alt={it.alt} className="plot-img" />
          ...
          <div className="trust-grid">
            <div className="trust-lead">
              ...
              <dl className="values">
                ...
                <div className="value">
                  <dt>Přesah</dt>
                  <dd>Vcítíme se do přání druhé strany a snažíme se předčit očekávání.</dd>
                </div>
              </dl>
